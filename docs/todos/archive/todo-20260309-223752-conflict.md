...
- [x] 在 `telemetry/field-spec.yaml` 中新增 `agentic.context.*` 字段并冻结 schema
- [x] 在 `agentic-fields.md` 中补 context 字段设计说明
- [x] 在 `docs/standards/change-context-log.md` 记录本次 OTLP field freeze
- [x] 运行最小文档/telemetry 校验
